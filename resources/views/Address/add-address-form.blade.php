                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="/address">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="address_line_1" type="address_line_1" class="form-control" name="address_line_1" value="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="address_line_2" type="address_line_2" class="form-control" name="address_line_2" value="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="town" type="town" class="form-control" name="town" value="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="state" type="state" class="form-control" name="state" value="">
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="postcode" type="postcode" class="form-control" name="postcode" value="">
