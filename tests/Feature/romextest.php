...
class RomexTest extends TestCase
{
    ...
    /** @test */
    public function user_add_complain(){
            $complain = factory('App\Complain')->create();
            $response = $this->post( '/complain', $complain->toArray());
            $this->assertDatabaseHas("complain", ["user_id"=>$complain->user_id, "title"=>$complain->title, "description"=>$complain->description]);
    }
}
